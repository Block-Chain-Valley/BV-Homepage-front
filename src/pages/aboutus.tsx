    ...
    <main className="flex flex-col items-center justify-center text-white bg-black ">
      ...
      >
        <div className="m-10 text-left text-5xl font-extrabold">
          블록체인 밸리는 <br />
          <span className="text-900">고려대학교 유일의 블록체인 학회</span>입니다
        </div>
      ...
      <div className="w-full h-100">
        ...
        <div className="flex">
          ...
          <div className="bg-black p-10 text-white text-center flex-1 flex flex-col items-center pb-20">
            ...
            <span className="text-lg">Web 3.0를 통해 자신의 미래를 준비하는 공간</span>
          </div>
        ...
        <div className="flex justify-center">
          <div className="bg-gray-300 pl-[30%] text-bold text-black text-lg pb-10 w-full leading-9" >
            ...
            <li>산업의 이해도를 높이기 위한 다양한 외부 기업과 강연, 리서치 등 산학협력 진행</li>
        ...
        <div className="flex justify-center">
          <div className="bg-gray-300 pl-[30%] text-bold text-black text-lg pb-10 w-full leading-9 pb-20" >
            ...
            <li>드림플러스 블록체인 해커톤 메타마스크 Snap 활용 트랜잭션 보안 서비스로 '안랩블록체인컴퍼니상' 수상</li>
            <li>Korea Blockchain Academy Conference(KOBAC) 주최 </li>
            <li>필로소피아벤처스와 업무협약 체결 - 안암 라운지 및 다양한 지원 제공</li>
          </div>
        </div>
        ...
        <div className="flex flex-row w-full">
          <div className="flex flex-grow">
            <div
              ...
              style={{
                backgroundImage: isHoveredCommon ? "url(/bv_common_0.5.png)" : "url(/bv_common.jpg)",
                backgroundSize: "cover",
                height: "500px",
              }}
              ...
              {isHoveredCommon ?
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                  <span className="text-white text-thin p-10">
                    블록체인에 핵심적인 DeFi 및 NFT 생태계에 대한 이해를 넓혀가며, 외부 연사 초청을 통해 보다 심화된 지식을 탐구하는 것 목표로 삼습니다. 3월엔 리서치 / 개발 팀장들의 리드 하에 공통세션이 진행되며, 그 이후에는 현직자 및 알럼나이, 외부연사 분들의 강의가 예정되어 있습니다.                  </span>
                </div>
                :
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                  <span className="flex items-center justify-center h-full text-4xl font-bold">공통</span>
                </div>
              }
            </div>
          </div>
          ...
          <div className="flex flex-grow">
            <div
              className="text-center pl-10 pr-10 w-full h-full relative"
              style={{
                backgroundImage: isHoveredResearch ? "url(/bv_research_0.5.png)" : "url(/bv_research.jpeg)",
                backgroundSize: "cover",
                height: "500px",
              }}
            ...
            >
              {isHoveredResearch ? (
                ...
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                  <span className="flex items-center justify-center h-full text-4xl font-bold">리서치</span>
                </div>
              )}
            </div>
          </div>
          <div className="flex flex-grow">
            <div
              className="text-center pl-10 pr-10 w-full h-full relative"
              style={{
                backgroundImage: isHoveredDevelop ? "url(/bv_develop_0.5.png)" : "url(/bv_develop.jpg)",
                backgroundSize: "cover",
                height: "500px",
              }}
            ...
            >
              {isHoveredDevelop ?
                ...
                :
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                  <span className="flex items-center justify-center h-full text-4xl font-bold">개발</span>
                </div>
              }
            </div>
          </div>
